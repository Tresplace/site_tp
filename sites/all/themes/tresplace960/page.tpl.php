...
?>
  ...
  <div id="main" class="column <?php print ns('grid-12', $page['sidebar_first'], 4, $page['sidebar_second'], 4) . ' ' . ns('push-4', !$page['sidebar_first'], 4); ?>">
...
<div id="footer">
    <?php if ($page['footer']): ?>
      <div id="footer-region" class="region container-12 clearfix">
